    ...
    <div className="">
      <div className="relative">
        ...
        <div className="flex  ">
          ...
          />
          {/* Title */}
          <div className="absolute text-white font-bold bottom-3 left-3 text-[15px] flex items-center gap-2">
            {title}
            <span>&#x2022;</span>
            <p className="text-[14px] text-slate-200"> ${price}</p>
          </div>
        </div>
      </div>
      {/* Description */}
      <div className="pt-3 flex justify-between items-start">
        ...
        <div className="">
          ...
          <p className="max-w-[17rem] font-semibold text-[14px]">${price}</p>
        </div>
        {/* Right */}
